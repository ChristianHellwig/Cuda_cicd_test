...
# echo "Installing GCC/G++ version ${built_tool_version}"
# $USE_SUDO apt-get install -y gcc-$built_tool_version g++-$built_tool_version
# export CC=/usr/bin/gcc-$built_tool_version
# export CXX=/usr/bin/g++-$built_tool_version
# export CUDAHOSTCXX=/usr/bin/g++-$built_tool_version
...
if [[ $GITHUB_ACTIONS ]]; then
    ...
    echo "CUDAHOSTCXX=$CUDAHOSTCXX" >> $GITHUB_ENV
fi
